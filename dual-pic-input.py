...
def numOfCarsJPEG(filename,display):
	...
	for detection in detections:
		if(detection.ClassID == 1 and detection.Bottom > MID_THRESHHOLD ):
...
savePath = '/home/gustav/direc_mount/Annotations_Copy/Annotations-merged/detectnetOutput2/'
